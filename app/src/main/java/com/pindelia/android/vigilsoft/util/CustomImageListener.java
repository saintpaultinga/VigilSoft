...
/**
 * Created by TSPDEV on 20/07/2016.
 */
public class CustomImageListener implements ImageListener {
    ...
    public static final Creator<CustomImageListener> CREATOR = new Creator<CustomImageListener>() {
        @Override
        public CustomImageListener createFromParcel(Parcel source) {
            return new CustomImageListener();
        }

        @Override
        public CustomImageListener[] newArray(int size) {
            return new CustomImageListener[size];
        }
    };
}